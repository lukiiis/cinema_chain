...
public class Film {
   ...
   private KategoriaFilmu kategoria;
    ...
    public Film(Long id_filmu, String tytul, String opis, String rezyser,
                String obraz_url, String plakat_url, LocalDate data_premiery,
                Long czas_trwania, KategoriaFilmu kategoria)
    {
