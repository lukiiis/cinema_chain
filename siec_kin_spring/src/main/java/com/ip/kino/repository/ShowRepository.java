...
public interface ShowRepository extends JpaRepository<Show, Long> {
    ...
    List<Show> findAllByKinoAndFilm(Long kinoId, Long filmId);
    ...
    List<Show> findAllByIdKIna(Long kinoId);
    ...
    List<Show> findAllByDataKinoSala(Long kinoId, Long salaId, LocalDate data);
    ...
    Movie findFilmById(@Param("id") Long id);

    @Query("SELECT k FROM Cinema k WHERE k.cinemaId = :id")
    Cinema findKinoById(@Param("id") Long id);
}
